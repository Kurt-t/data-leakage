...
# understanding lambda function, and the default value for axis filter()
# the following lines compute mean of several numbers on each row ->
...
#         min_max_scaler = preprocessing.MinMaxScaler((-1,1))  # what is MinMaxScaler -> knowledge
#         return min_max_scaler.fit_transform(x)  # problematic
#     return x
# r = r.apply(f, axis=0)  # axis=0 -> function applied to each column
...
# desired range of transformed data: all columns to minmaxscale after X dropping ABANDONA_ALU
